...
const average = (arr) =>
  Math.ceil(arr.reduce((acc, cur, _, arr) => acc + cur / arr.length, 0));
...
function App() {
  ...
  //Note: Creating side-effect like these inside render logic creates infinte loop
  //// 1) Fetching data in render logic
  // fetch(`http://www.omdbapi.com/?apikey=${KEY}&s=Interstellar`)
  //   .then((res) => res.json())
  //   .then((data) => console.log(data));
  //// 2) Using setter function like this
  // setWatched([]);
    ...
    <>
      ...
      <Main>
        <Box>
          ...
          {isLoading && <Loader />}
          {!isLoading && !error && (
            <MovieList movies={movies} onMovieSelection={handleSelectMovie} />
          )}
...
function MovieDetails({
  ...
  function handleAdd() {
    const newWatchedMovie = {
      ...
      year,
      userRating,
      countRatingDecisions: countRate.current,
    };
  ...
  useEffect(() => {
    ...
    //// Clean up function
    return () => (document.title = "Popcornify");
  }, [title]);
...
//   return (
//     <div className="box">
//       <Button onClick={handleShow} isOpen={isOpen2} />
